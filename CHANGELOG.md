...
| :--------------------------------------------------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **[Universal EXE (x64/arm64)](https://github.com/BurntToasters/CONV2/releases/download/v1.5.0/CONV2-Win.exe)**               | **[Universal DMG](https://github.com/BurntToasters/CONV2/releases/download/v1.5.0/CONV2-MacOS-universal.dmg)**  | **AppImage:** [x64](https://github.com/BurntToasters/CONV2/releases/download/v1.5.0/CONV2-Linux-x86_64.AppImage) / [arm64](https://github.com/BurntToasters/CONV2/releases/download/v1.5.0/CONV2-Linux-arm64.AppImage) |
...
|                                                                                                                              |                                                                                                                 | **Flatpak:** [x64](https://github.com/BurntToasters/CONV2/releases/download/v1.5.0/CONV2-Linux-x86_64.flatpak) / [arm64](https://github.com/BurntToasters/CONV2/releases/download/v1.5.0/CONV2-Linux-aarch64.flatpak)  |
