...
| *See MSI note in releases* | | **RPM:** [x64](https://github.com/BurntToasters/CONV2/releases/download/v1.3.3/CONV2-Linux-x86_64.rpm) / [arm64](https://github.com/BurntToasters/CONV2/releases/download/v1.3.3/CONV2-Linux-aarch64.rpm) |
