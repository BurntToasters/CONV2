...
const MANIFEST = 'com.burnttoasters.conv2.yml';
const APP_ID = 'com.burnttoasters.conv2';
...
const BUNDLE_NAMES = {
  x86_64: 'CONV2-Linux-x86_64.flatpak',
  aarch64: 'CONV2-Linux-aarch64.flatpak',
};
...
function main() {
  ...
  switch (command) {
    ...
    default:
      console.log('CONV2 Flatpak Build Script\n');
